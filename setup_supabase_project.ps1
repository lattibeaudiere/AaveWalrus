# Setup script for Supabase project: djxssxhnmucmvfugvyta
# Usage: .\setup_supabase_project.ps1 -ConnectionString 'your_connection_string'
...
Write-Host "Setting Up Supabase Project" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
